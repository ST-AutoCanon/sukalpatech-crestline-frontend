...
export default function Sidebar({
  ...
  return (
    <>
      {/* ================= DESKTOP SIDEBAR ================= */}
      <aside
        className={`hidden md:flex flex-col bg-white shadow-md transition-all duration-300 ${sidebarOpen ? "w-64 p-6" : "w-20 p-3"
          }`}
      >
        {/* Logo */}
        {sidebarOpen && (
        ...
        <div className="flex justify-end mb-4">
          ...
          >
            {sidebarOpen ? (
              <ArrowLeft size={22} />   // ← AFTER OPEN
            ) : (
              <ArrowRight size={22} />  // → BEFORE OPEN
            )}
          </button>
