...
import Goldbusiness from "./goldbusinessCard"; // <-- import your card component here
...
const UpdatedGoldRequests: React.FC<Props> = ({ onBack }) => {
...
export default UpdatedGoldRequests;