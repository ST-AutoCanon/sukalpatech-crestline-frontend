      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {prs.map((pr) => {
          ...
          return (
            <div
              key={pr.id}
              className="relative bg-white rounded-xl p-5 shadow-md"
            >
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-gray-700">ITC</span>
                </div>
                <div className="flex justify-between">
      ...
      {activePR && (
        <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/50 overflow-y-auto p-4">
          <div className="bg-white w-full max-w-7xl rounded-xl shadow-xl p-6 text-black">
            ...
            {/* Statuses Section */}
            <div className="mb-6">
              {/* Max/Min button above the thin black border */}
              ...
              {/* Thin black border around statuses */}
