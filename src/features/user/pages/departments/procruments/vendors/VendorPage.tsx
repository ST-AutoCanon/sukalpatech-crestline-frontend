...
import UpdateVendors from "./UpdateVendor";
import EmployeeDashboard from "../procrumentHome"; // import the component
import { Plus } from "lucide-react";

const VendorPage: React.FC = () => {
  const [activeTab, setActiveTab] = useState<"addVendor" | "allVendors" | "updateVendor">(
    "allVendors"
  );
    ...
    <div className="px-6 py-4">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <button
            onClick={() => setActiveTab("updateVendor")}
