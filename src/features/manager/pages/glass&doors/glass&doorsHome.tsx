...
import GlassDoorsPage from "./glass&doorspage";
...
const GlassandDoorsHome: React.FC = () => {
  const [activeTab, setActiveTab] = useState<"glass&doors" | "projects" | "update project">(
    "glass&doors",
  );
  ...
  return (
    <div className="w-full h-full bg-gradient-to-r from-[#4b1b7a] to-[#2d2a8c] text-white">
      <div className="w-full px-4 sm:px-6 md:px-10 pt-5 md:pt-8 flex items-center justify-between">
        ...
        ${
          activeTab === "glass&doors" && requestType === "drawings"
...
export default GlassandDoorsHome;
