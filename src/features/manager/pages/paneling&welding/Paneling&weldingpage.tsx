...
export default function PannelingWeldingPage() {
    ...
    try {
      ...
      const notifResponse = await fetch(`${BACKEND_URL}/api/notifications`, {
        ...
        body: JSON.stringify({
          ...
          message:
            "paneling and welding department completed the project and moved to next department",
          type: "PROJECT_MOVED",
          ...
          // recipient_id: 54,
          metadata: { department: "Panneling & Welding" },
        }),
      });
    ...
    <div className="w-full min-h-[80vh] p-6">
      ...
      <div className="bg-white rounded-2xl shadow-md p-6">
        ...
        <p className="text-gray-600 mb-6">
          Manage panneling drawings, design approvals, and technical
          documentation.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-gray-50 p-5 rounded-xl border">
            ...
            <p className="text-sm text-gray-500">
              Upload and manage panneling drawings.
            </p>
          </div>
