...
import InteriorFitmentPage from "./InteriorFitmentPage";
...
const InteriorFitmentHome: React.FC = () => {
  const [activeTab, setActiveTab] = useState<"InteriorFitment" | "projects" | "update project">(
    "InteriorFitment",
  );
  ...
  return (
    <div className="w-full h-full bg-gradient-to-r from-[#4b1b7a] to-[#2d2a8c] text-white">
      <div className="w-full px-4 sm:px-6 md:px-10 pt-5 md:pt-8 flex items-center justify-between">
        ...
        ${
          activeTab === "InteriorFitment" && requestType === "drawings"
      ...
      <div className="px-3 sm:px-5 md:px-10 pt-4 md:pt-6 pb-10">
        {activeTab === "InteriorFitment" && requestType === "drawings" && (
          <InteriorFitmentPage type="drawings" />
        )}
...
export default InteriorFitmentHome;
