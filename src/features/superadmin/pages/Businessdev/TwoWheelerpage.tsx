...
>
  {loading
    ...
    : "Save"}
            ...
            <div className="mt-10">
  <h3 className="text-lg font-semibold mb-3">Business List</h3>
    ...
    <table className="w-full border text-sm">
      <thead className="bg-gray-100">
        <tr>
          ...
          <th className="p-2 border">Vehicle Modal</th>
          <th className="p-2 border">Motor Capacity</th>
          <th className="p-2 border">Battery Type</th>
      ...
      <tbody>
        {businessList.map((item) => (
          <tr key={item.id}>
            ...
            <td className="p-2 border">{item.contact_person}</td>
            <td className="p-2 border">{item.phone}</td>
            <td className="p-2 border">{item.email}</td>
            <td className="p-2 border">{item.estimated_budget}</td>
            <td className="p-2 border">{item.vehicle_model}</td>
            <td className="p-2 border">{item.motor_capacity}</td>
            <td className="p-2 border">{item.battery_type}</td>
