  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4 sm:p-6 md:p-8">
      ...
      >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                required
                className="w-full rounded-xl bg-white/20 text-white placeholder-white/60 px-4 py-2.5 
                           focus:outline-none focus:ring-2 focus:ring-[#3A8DFF]/70 border border-white/20"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-2 py-2.5 rounded-xl font-semibold text-white 
                         bg-linear-to-r from-[#0092B8] via-[#3A8DFF] to-[#9810FA] 
        ...
        <button
          onClick={onClose}
          className="absolute top-3 right-4 text-white text-3xl hover:text-white"
        >
          &times;
        </button>
      </div>
