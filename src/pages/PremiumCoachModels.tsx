...
// export default function PremiumCoachModels() {
//   return (
//     <section className="bg-[#0b1328] py-20 text-white font-inter">
//       <div className="max-w-7xl mx-auto px-6 lg:px-10 text-center">
//         {/* Section Badge */}
//         <span className="inline-block px-4 py-1.5 rounded-full text-sm font-medium bg-gradient-to-r from-pink-500 to-purple-600 text-white shadow-md">
//           Our Vehicles
//         </span>
...
//           Premium Coach Models
//         </h2>
//         <p className="text-gray-300 mt-3 mb-12">
//           Custom solutions for every application
//         </p>
...
//             ]}
//             bulletColor="text-pink-500"
//             buttonColor="bg-gradient-to-r from-pink-500 to-purple-600"
//           />
...
// }) {
//   return (
//     <div className="bg-[#0f1b33] rounded-2xl border border-white/10 shadow-[0_0_20px_rgba(255,255,255,0.05)] hover:border-white/20 transition-all overflow-hidden text-left">
//       {/* Image */}
...
//         />
//         {badge && (
//           <span className="absolute top-3 right-3 bg-gradient-to-r from-yellow-400 to-orange-500 text-white text-xs font-semibold px-3 py-1 rounded-full shadow-md">
//             {badge}
//           </span>
//         )}
//       </div>
...
//       {/* Content */}
//       <div className="p-6">
//         <p className="text-sm font-medium text-purple-400 mb-1">{category}</p>
...
//   return (
//     <div
//       className="relative bg-[#0f1b33] rounded-2xl border border-white/10
//       shadow-[0_0_20px_rgba(255,255,255,0.05)] transition-all duration-300
//       hover:border-white/20 hover:shadow-[0_0_25px_rgba(173,70,255,0.15)]
//       hover:-translate-y-1 overflow-hidden text-left group"
//     >
//       {/* Subtle gradient overlay */}
//       <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-10 bg-gradient-to-r from-pink-500 to-purple-600 transition-opacity duration-300"></div>
...
//         <button
//           className={`w-full text-white font-medium py-2.5 rounded-lg ${buttonColor} hover:opacity-90 transition relative overflow-hidden`}
//         >
//           <span className="relative z-10">Learn More</span>
//           {/* Gradient shimmer effect */}
//           <span className="absolute inset-0 bg-gradient-to-r from-white/20 to-transparent opacity-0 group-hover:opacity-20 transition-opacity duration-300"></span>
//         </button>
//       </div>
//     </div>
//   );
